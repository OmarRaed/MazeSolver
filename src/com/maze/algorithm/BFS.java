...
/**
 * An algorithm class that calculates the solution path based on Breadth first search algorithm
 */
public class BFS {
    ...
    //an empty Maze Queue that will holds mazes to visit
    public Queue<TreeNode> mazeQueue = new LinkedList<>();
    ...
    public void explore(TreeNode treeNode) {
        ...
        System.out.println(treeNode.getMaze().getCost());
...
//        treeNode.getMaze().printWorld();
    ...
    /**
     * Method called to find a solution for a level using Breadth First Search algorithm
     */
    public int runBreadthFirstSearch(String level) {
        ...
        while (!isSolved) {
            ...
            explore(Objects.requireNonNull(mazeQueue.poll()));
        }
